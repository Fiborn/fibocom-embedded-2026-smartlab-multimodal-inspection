...
: Node("vision_node", options)
{
  ...
  this->declare_parameter<std::string>("huawei_mqtt_server", "your_mqtt_server");
  ...
  this->declare_parameter<std::string>("device_id", "your_product_id_your_device");
  this->declare_parameter<std::string>("device_secret", "your_device_secret");
  ...
  // 警告：API Key不应硬编码
  if (qwen_api_key_.empty() || qwen_api_key_ == "your_qwen_api_key") {
